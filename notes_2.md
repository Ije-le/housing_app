...
One major problem I encountered with building this app is that the minutes themsleves were not written in very conversational language or in too many words, so the summaries sounded like them. In trying to merge multiple excerpts together, I was getting summaries that looked like this:
